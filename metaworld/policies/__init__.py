...
from metaworld.policies.sawyer_coffee_pull_v2_policy import SawyerCoffeePullV2Policy, SawyerCoffeePullV2PolicyNewV0
...
from metaworld.policies.sawyer_hand_insert_v1_policy import SawyerHandInsertV1Policy
